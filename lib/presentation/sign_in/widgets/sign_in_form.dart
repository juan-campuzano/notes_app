    ...
    return BlocConsumer<SignInFormBloc, SignInFormState>(
      builder: (context, state) {
        return Form(
          ...
          child: ListView(
            children:  [
              const Text("📝", style: TextStyle(fontSize: 130), textAlign: TextAlign.center,),
              ...
              TextFormField(
                ...
                validator: (_) => context.read<SignInFormBloc>().state.emailAddress.value.fold(
                  ...
                  (f) => f.maybeMap(invalidEmail: ((value) => value.failedValue), orElse: () => null),
              ...
              TextFormField(
                ...
                validator: (_) => context.read<SignInFormBloc>().state.password.value.fold(
                  ...
                  (f) => f.maybeMap(shortPassword: ((value) => 'Short Password'), orElse: () => null),
